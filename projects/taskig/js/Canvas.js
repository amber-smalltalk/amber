...
fn: function (anObject){
var self=this;
return smalltalk.send(smalltalk.send(self, "_td", []), "_with_", [anObject]);
return self;},
args: ["anObject"],
source: unescape("td%3A%20anObject%0A%20%20%20%20%5Eself%20td%20with%3A%20anObject"),
messageSends: ["with:", "td"],
referencedClasses: []
}),
smalltalk.HTMLCanvas);
