...
fn: function (){
var self=this;
(($receiver = smalltalk.send(self, "_currentSlide", [])) != nil && $receiver != undefined) ? (function(){smalltalk.send(smalltalk.send(".slide", "_asJQuery", []), "_hide", []);smalltalk.send(smalltalk.send(smalltalk.send(unescape("%23"), "__comma", [smalltalk.send(smalltalk.send(self, "_currentSlide", []), "_id", [])]), "_asJQuery", []), "_show", []);return smalltalk.send(smalltalk.send("title", "_asJQuery", []), "_text_replace_with_", [smalltalk.send(smalltalk.send(smalltalk.send(self, "_title", []), "__comma", [unescape("%20-%20")]), "__comma", [smalltalk.send(smalltalk.send(self, "_currentSlide", []), "_id", [])]), "Slide", ""]);})() : nil;
return self;},
args: [],
source: unescape('showCurrentSlide%0A%09self%20currentSlide%20ifNotNil%3A%20%5B%0A%09%09%27.slide%27%20asJQuery%20hide.%0A%09%09%28%27%23%27%2C%20self%20currentSlide%20id%29%20asJQuery%20show.%0A%20%20%20%20%20%20%20%20%20%20%09%27title%27%20asJQuery%20text%3A%20self%20title%2C%20%27%20-%20%27%2C%20self%20currentSlide%20id%20replace%3A%20%27Slide%27%20with%3A%20%27%27.%0A%20%20%20%20%20%20%20%20%5D'),
messageSends: ["ifNotNil:", "currentSlide", "hide", "asJQuery", "show", unescape("%2C"), "id", "text:replace:with:", "title"],
referencedClasses: []
}),
smalltalk.Presentation);
...
fn: function (){
var self=this;
return smalltalk.send(smalltalk.send(smalltalk.send(self, "_allSubclasses", []), "_select_", [(function(aPresentationClass){return smalltalk.send(aPresentationClass, "_isConcrete", []);})]), "_reversed", []);
return self;},
args: [],
source: unescape('concretePresentations%0A%09%5E%20%28self%20allSubclasses%20select%3A%20%5B%3AaPresentationClass%7C%20aPresentationClass%20isConcrete%5D%29%20reversed'),
messageSends: ["reversed", "select:", "allSubclasses", "isConcrete"],
referencedClasses: []
}),
...
smalltalk.send(smalltalk.send(self['@slideSelect'], "_asJQuery", []), "_val_", [smalltalk.send(smalltalk.send(self, "_currentPresentation", []), "_currentSlideIndex", [])]);
return self;},
args: [],
source: unescape('updateHash%0A%09document%20location%20hash%3A%20self%20currentPresentation%20class%20name%2C%20%27-%27%2C%20self%20currentPresentation%20currentSlideIndex.%0A%09slideSelect%20asJQuery%20val%3A%20self%20currentPresentation%20currentSlideIndex.'),
messageSends: ["hash:", "location", unescape("%2C"), "name", "class", "currentPresentation", "currentSlideIndex", "val:", "asJQuery"],
referencedClasses: []
}),
smalltalk.PresentationNavigator);
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_with_", ["Toggle IDE"]);return smalltalk.send($rec, "_onClick_", [(function(){return smalltalk.send((typeof window == 'undefined' ? nil : window), "_toggleAmberIDE", []);})]);})(smalltalk.send(html, "_a", []));
smalltalk.send(html, "_with_", [unescape("%20%7C%20")]);
(function($rec){smalltalk.send($rec, "_with_", ["Reload Slides"]);return smalltalk.send($rec, "_onClick_", [(function(){return smalltalk.send(self, "_reload", []);})]);})(smalltalk.send(html, "_a", []));
smalltalk.send(html, "_with_", [unescape("%20%7C%20")]);
...
return self;},
args: ["html"],
source: unescape('renderToolsOn%3A%20html%0A%09html%20a%0A%09%09with%3A%20%27Toggle%20IDE%27%3B%0A%09%09onClick%3A%20%5Bwindow%20toggleAmberIDE%5D.%0A%09html%20with%3A%20%27%20%7C%20%27.%0A%09html%20a%0A%09%09with%3A%20%27Reload%20Slides%27%3B%0A%09%09onClick%3A%20%5Bself%20reload%5D.%0A%09html%20with%3A%20%27%20%7C%20%27.%0A%09html%20a%0A%09%09with%3A%20%27%u2190%27%3B%0A%09%09onClick%3A%20%5Bself%20previousSlide%5D.%0A%09html%20a%0A%09%09with%3A%20%27%u2192%27%3B%0A%09%09onClick%3A%20%5Bself%20nextSlide%5D.'),
messageSends: ["with:", "onClick:", "toggleAmberIDE", "a", "reload", "previousSlide", "nextSlide"],
referencedClasses: []
}),
smalltalk.PresentationNavigator);
...
(index=(0));return smalltalk.send(smalltalk.send(self, "_currentPresentation", []), "_slidesDo_", [(function(aSlide){(index=((($receiver = index).klass === smalltalk.Number) ? $receiver +(1) : smalltalk.send($receiver, "__plus", [(1)])));return (function($rec){smalltalk.send($rec, "_value_", [index]);return smalltalk.send($rec, "_with_", [smalltalk.send(smalltalk.send(aSlide, "_title", []), "_replace_with_", ["Slide", ""])]);})(smalltalk.send(html, "_option", []));})]);})]);
return self;},
args: [],
source: unescape('updateSlideSelect%0A%09slideSelect%20contents%3A%20%5B%3Ahtml%7C%20%7Cindex%7C%0A%09%09%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09index%20%3A%3D%200.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%20%20%20%20%20%20%20%09%09self%20currentPresentation%20slidesDo%3A%20%5B%20%3AaSlide%7C%20%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%09%09index%20%3A%3D%20index%20+%201.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%09%09html%20option%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%20%20%20%20%09%09%09%09%09value%3A%20index%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09%09%09%09%09%09%09with%3A%20%28aSlide%20title%20replace%3A%20%27Slide%27%20with%3A%20%27%27%29%5D%20%5D.'),
messageSends: ["contents:", "slidesDo:", "currentPresentation", unescape("+"), "value:", "with:", "replace:with:", "title", "option"],
referencedClasses: []
}),
smalltalk.PresentationNavigator);
...
fn: function (){
var self=this;
smalltalk.send(smalltalk.send("title", "_asJQuery", []), "_text_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(self, "_presentation", []), "_title", []), "__comma", [unescape("%20-%20")]), "__comma", [smalltalk.send(smalltalk.send(self, "_id", []), "_replace_with_", ["Slide", ""])])]);
...
return self;},
args: [],
source: unescape('title%0A%09%5E%27FOSDEM%27'),
messageSends: [],
referencedClasses: []
}),
smalltalk.FOSDEM2012Presentation.klass);
