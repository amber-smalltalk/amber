...
return self;},
args: ["html"],
source: unescape('renderOn%3A%20html%0A%09%22html%20div%20class%3A%20%27title%27%3B%20with%3A%20%5B%20html%20h1%20with%3A%20%27Todos%27%20%5D.%22%0A%09html%20div%20class%3A%20%27content%27%3B%20with%3A%20%5B%20self%0A%09%09renderFormOn%3A%20html%3B%0A%09%09renderListOn%3A%20html%3B%0A%09%09renderStatsOn%3A%20html%20%5D'),
messageSends: ["class:", "with:", "renderFormOn:", "renderListOn:", "renderStatsOn:", "div"],
referencedClasses: []
}),
smalltalk.TodoApp);
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_id_", ["todos"]);return smalltalk.send($rec, "_with_", [(function(){(function($rec){smalltalk.send($rec, "_id_", [unescape("todo-actions")]);return smalltalk.send($rec, "_with_", [(function(){(function($rec){smalltalk.send($rec, "_id_", [unescape("check-all")]);smalltalk.send($rec, "_class_", ["check"]);return smalltalk.send($rec, "_type_", ["checkbox"]);})(smalltalk.send(html, "_input", []));return (function($rec){smalltalk.send($rec, "_for_", [unescape("check-all")]);return smalltalk.send($rec, "_with_", ["Mark all as complete"]);})(smalltalk.send(html, "_label", []));})]);})(smalltalk.send(html, "_div", []));return smalltalk.send(smalltalk.send(html, "_ul", []), "_id_", [unescape("todo-list")]);})]);})(smalltalk.send(html, "_div", []));
return self;},
args: ["html"],
source: unescape('renderListOn%3A%20html%0A%09html%20div%20id%3A%20%27todos%27%3B%20with%3A%20%5B%0A%09%09html%20div%20id%3A%20%27todo-actions%27%3B%20with%3A%20%5B%0A%09%09%09html%20input%20id%3A%20%27check-all%27%3B%20class%3A%20%27check%27%3B%20type%3A%20%27checkbox%27.%0A%09%09%09html%20label%20for%3A%20%27check-all%27%3B%20with%3A%20%27Mark%20all%20as%20complete%27%20%5D.%0A%09%09html%20ul%20id%3A%20%27todo-list%27%20%5D'),
messageSends: ["id:", "with:", "class:", "type:", "input", "for:", "label", "div", "ul"],
referencedClasses: []
}),
smalltalk.TodoApp);
...
smalltalk.addClass('Todo', smalltalk.Widget, ['content'], 'Todos');
smalltalk.addMethod(
unescape('_renderOn_'),
smalltalk.method({
selector: unescape('renderOn%3A'),
...
fn: function (html){
var self=this;
(function($rec){smalltalk.send($rec, "_class_", ["todo"]);return smalltalk.send($rec, "_with_", [(function(){(function($rec){smalltalk.send($rec, "_class_", ["display"]);return smalltalk.send($rec, "_with_", [(function(){(function($rec){smalltalk.send($rec, "_class_", ["check"]);return smalltalk.send($rec, "_type_", ["checkbox"]);})(smalltalk.send(html, "_input", []));(function($rec){smalltalk.send($rec, "_class_", [unescape("todo-content")]);return smalltalk.send($rec, "_with_", [self['@content']]);})(smalltalk.send(html, "_div", []));return smalltalk.send(smalltalk.send(html, "_span", []), "_class_", [unescape("todo-destroy")]);})]);})(smalltalk.send(html, "_div", []));return (function($rec){smalltalk.send($rec, "_class_", ["edit"]);return smalltalk.send($rec, "_with_", [(function(){return (function($rec){smalltalk.send($rec, "_class_", [unescape("todo-input")]);return smalltalk.send($rec, "_type_", ["text"]);})(smalltalk.send(html, "_input", []));})]);})(smalltalk.send(html, "_div", []));})]);})(smalltalk.send(html, "_li", []));
return self;},
args: ["html"],
source: unescape('renderOn%3A%20html%0A%09html%20li%20class%3A%20%27todo%27%3B%20with%3A%20%5B%0A%09%09html%20div%20class%3A%20%27display%27%3B%20with%3A%20%5B%0A%09%09%09html%20input%20class%3A%20%27check%27%3B%20type%3A%20%27checkbox%27.%0A%09%09%09html%20div%20class%3A%20%27todo-content%27%3B%20with%3A%20content.%0A%09%09%09html%20span%20class%3A%20%27todo-destroy%27%20%5D.%0A%09%09html%20div%20class%3A%20%27edit%27%3B%20with%3A%20%5B%0A%09%09%09html%20input%20class%3A%20%27todo-input%27%3B%20type%3A%20%27text%27%20%5D%5D.'),
messageSends: ["class:", "with:", "type:", "input", "div", "span", "li"],
referencedClasses: []
}),
smalltalk.Todo);
