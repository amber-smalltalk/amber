...
fn: function (){
var self=this;
return smalltalk.send((smalltalk.Dictionary || Dictionary), "_fromPairs_", [smalltalk.send(smalltalk.send(self, "_keys", []), "_collect_", [(function(key){return smalltalk.send(key, "__minus_gt", [smalltalk.send(self, "_at_", [key])]);})])]);
return self;},
args: [],
source: unescape('asDictionary%0A%09%5E%20Dictionary%20fromPairs%3A%20%28self%20keys%20collect%3A%5B%3Akey%7C%0A%09%09%09%09%09%09%09%09key%20-%3E%20%28self%20at%3A%20key%29%5D%29'),
messageSends: ["fromPairs:", "collect:", "keys", unescape("-%3E"), "at:"],
referencedClasses: ["Dictionary"]
}),
smalltalk.JSObjectProxy);
...
return self;},
args: [],
source: unescape('keys%0A%09%3Creturn%20Object.keys%28self%5B%27@jsObject%27%5D%29%3E'),
messageSends: [],
referencedClasses: []
}),
smalltalk.JSObjectProxy);
