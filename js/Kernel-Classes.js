...
var self=this;
try{((($receiver = smalltalk.send(smalltalk.send(self, "_methodDictionary", []), "_includesKey_", [selector])).klass === smalltalk.Boolean) ? ($receiver ? (function(){return (function(){throw({name: 'stReturn', selector: '_canUnderstand_', fn: function(){return true}})})();})() : nil) : smalltalk.send($receiver, "_ifTrue_", [(function(){return (function(){throw({name: 'stReturn', selector: '_canUnderstand_', fn: function(){return true}})})();})]));
((($receiver = smalltalk.send(smalltalk.send(self, "_superclass", []), "__eq_eq", [nil])).klass === smalltalk.Boolean) ? ($receiver ? (function(){return (function(){throw({name: 'stReturn', selector: '_canUnderstand_', fn: function(){return false}})})();})() : nil) : smalltalk.send($receiver, "_ifTrue_", [(function(){return (function(){throw({name: 'stReturn', selector: '_canUnderstand_', fn: function(){return false}})})();})]));
(function(){throw({name: 'stReturn', selector: '_canUnderstand_', fn: function(){return smalltalk.send(smalltalk.send(self, "_superclass", []), "_canUnderstand_", [selector])}})})();
return self;
} catch(e) {if(e.name === 'stReturn' && e.selector === '_canUnderstand_'){return e.fn()} throw(e)}},
args: ["selector"],
source: unescape('canUnderstand%3A%20selector%20%0A%09%22Answer%20whether%20the%20receiver%20can%20respond%20to%20the%20message%20whose%20selector%20%0A%09is%20the%20argument.%20The%20selector%20can%20be%20in%20the%20method%20dictionary%20of%20the%20%0A%09receiver%27s%20class%20or%20any%20of%20its%20superclasses.%22%0A%0A%09%28self%20methodDictionary%20includesKey%3A%20selector%29%20ifTrue%3A%20%5B%5Etrue%5D.%0A%09self%20superclass%20%3D%3D%20nil%20ifTrue%3A%20%5B%5Efalse%5D.%0A%09%5E%20self%20superclass%20canUnderstand%3A%20selector'),
messageSends: ["ifTrue:", "includesKey:", "methodDictionary", unescape("%3D%3D"), "superclass", "canUnderstand:"],
referencedClasses: []
}),
smalltalk.Behavior);
