...
var self=this;
return smalltalk.withContext(function($ctx1) { $ctx1.root=nil;
$ctx1.locals.root=_st(self["@canvas"])._root();
_st(self["@canvas"])._root_(self);
_st(aBlock)._value_(self["@canvas"]);
_st(self["@canvas"])._root_($ctx1.locals.root);
...
fn: function (html){
var self=this;
return smalltalk.withContext(function($ctx1) { return self}, self, "renderOn:", [html], smalltalk.Widget)}
}),
smalltalk.Widget);
...
;
return self}, self, "asJQuery", [], smalltalk.JSObjectProxy)}
}),
