...
fn: function (aClass, aStream) {
    ...
    aClass._instanceVariableNames()._do_separatedBy_(function (each) {return aStream._nextPutAll_(unescape("%27").__comma(each).__comma(unescape("%27")));}, function () {return aStream._nextPutAll_(unescape("%2C%20"));});
