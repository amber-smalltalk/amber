...
return self;},
args: ["anObject"],
source: unescape('occurrencesOf%3A%20anObject%20%0A%09%22Answer%20how%20many%20of%20the%20receiver%27s%20elements%20are%20equal%20to%20anObject.%22%0A%0A%09%7C%20tally%20%7C%0A%09tally%20%3A%3D%200.%0A%09self%20do%3A%20%5B%3Aeach%20%7C%20anObject%20%3D%20each%20ifTrue%3A%20%5Btally%20%3A%3D%20tally%20+%201%5D%5D.%0A%09%5Etally'),
messageSends: ["do:", "ifTrue:", unescape("%3D"), unescape("+")],
referencedClasses: []
}),
smalltalk.Collection);
...
smalltalk.addMethod(
unescape('_capitalized'),
smalltalk.method({
selector: unescape('capitalized'),
category: 'converting',
fn: function (){
var self=this;
var stream=nil;
...
return self;},
args: [],
source: unescape('capitalized%0A%09%22Answers%20a%20copy%20of%20this%20string%2C%20with%20its%20first%20letter%20in%20uppercase.%22%0A%09%7Cstream%7C%0A%09stream%20%3A%3D%20StringStream%20on%3A%20String%20new.%0A%0A%09%5E%20%28stream%0A%09%09nextPut%3A%20self%20first%20asUppercase%3B%0A%09%09nextPutAll%3A%20self%20allButFirst%29%20contents%0A'),
...
return self;},
args: [],
source: unescape('isLetter%0A%0A%09%5E%20self%20isDigit%20not'),
...
return self;},
args: [],
source: unescape('isDigit%0A%0A%09%5E%20self%20asNumber%20%3E%3D%200%20or%3A%5B%0A%09self%20asNumber%20%3C%200%5D'),
messageSends: ["or:", unescape("%3E%3D"), "asNumber", unescape("%3C")],
referencedClasses: []
}),
smalltalk.CharacterArray);
...
return self;},
args: ["anIndex", "aBlock"],
source: unescape('at%3A%20anIndex%20ifAbsent%3A%20aBlock%0A%09%3Creturn%20String%28self%29.charAt%28anIndex%20-%201%29%20%7C%7C%20aBlock%28%29%3E'),
messageSends: [],
referencedClasses: []
}),
smalltalk.String);
...
smalltalk.addMethod(
unescape('_shortenedTo_'),
smalltalk.method({
selector: unescape('shortenedTo%3A'),
category: 'converting',
fn: function (maxLength){
var self=this;
return ((($receiver = ((($receiver = smalltalk.send(self, "_size", [])).klass === smalltalk.Number) ? $receiver <=maxLength : smalltalk.send($receiver, "__lt_eq", [maxLength]))).klass === smalltalk.Boolean) ? ($receiver ? (function(){return self;})() : (function(){return smalltalk.send(smalltalk.send(self, "_copyFrom_to_", [(1), ((($receiver = maxLength).klass === smalltalk.Number) ? $receiver -(3) : smalltalk.send($receiver, "__minus", [(3)]))]), "__comma", ["..."]);})()) : smalltalk.send($receiver, "_ifTrue_ifFalse_", [(function(){return self;}), (function(){return smalltalk.send(smalltalk.send(self, "_copyFrom_to_", [(1), ((($receiver = maxLength).klass === smalltalk.Number) ? $receiver -(3) : smalltalk.send($receiver, "__minus", [(3)]))]), "__comma", ["..."]);})]));
return self;},
args: ["maxLength"],
source: unescape('shortenedTo%3A%20maxLength%0A%09%22Return%20a%20copy%20suitably%20shortened%20adding%20elipsis.%22%0A%0A%09%5E%20self%20size%20%3C%3D%20maxLength%0A%09%09ifTrue%3A%0A%09%09%09%5Bself%5D%0A%09%09ifFalse%3A%0A%09%09%09%5B%28self%20copyFrom%3A%201%20to%3A%20%28maxLength%20-%203%29%29%2C%20%27...%27%5D%0A'),
messageSends: ["ifTrue:ifFalse:", unescape("%3C%3D"), "size", unescape("%2C"), "copyFrom:to:", unescape("-")],
referencedClasses: []
}),
smalltalk.String);
...
args: [],
source: unescape('precedence%0A%09%22Answer%20the%20receiver%27s%20precedence%2C%20assuming%20it%20is%20a%20valid%20Smalltalk%0A%09message%20selector%20or%200%20otherwise.%20%20The%20numbers%20are%201%20for%20unary%2C%0A%092%20for%20binary%20and%203%20for%20keyword%20selectors.%22%0A%0A%09self%20size%20%3D%200%20ifTrue%3A%20%5B%5E%200%5D.%0A%09self%20first%20isLetter%20ifFalse%3A%20%5B%5E%202%5D.%0A%09self%20last%20%3D%20%27%3A%27%20ifTrue%3A%20%5B%5E%203%5D.%0A%09%5E%201'),
messageSends: ["ifTrue:", unescape("%3D"), "size", "ifFalse:", "isLetter", "first", "last"],
referencedClasses: []
}),
smalltalk.Symbol);
...
return self;},
args: [],
source: unescape('isKeyword%0A%09%22Answer%20whether%20the%20receiver%20is%20a%20message%20keyword.%22%0A%0A%09%5E%20self%20precedence%20%3D%203'),
messageSends: [unescape("%3D"), "precedence"],
referencedClasses: []
}),
smalltalk.Symbol);
...
return self;},
args: [],
source: unescape('isUnary%0A%09%22Answer%20whether%20the%20receiver%20is%20an%20unary%20message%20selector.%22%0A%0A%09%5E%20self%20precedence%20%3D%201'),
messageSends: [unescape("%3D"), "precedence"],
referencedClasses: []
}),
smalltalk.Symbol);
...
return self;},
args: ["aKey", "aBlock"],
source: unescape('removeKey%3A%20aKey%20ifAbsent%3A%20aBlock%0A%0A%09%3C%0A%09%09var%20index%20%3D%20self%5B%27@keys%27%5D.indexOf%28aKey%29%3B%0A%09%09if%28index%20%3D%3D%3D%20-1%29%20%7B%0A%09%09%09return%20aBlock%28%29%0A%09%09%7D%20else%20%7B%0A%09%09%09self%5B%27@keys%27%5D.splice%28index%2C%201%29%3B%0A%09%09%09self%5B%27@values%27%5D.splice%28index%2C%201%29%3B%0A%09%09%09return%20aKey%0A%09%09%7D%3B%0A%09%3E'),
messageSends: [],
referencedClasses: []
}),
smalltalk.Dictionary);
