...
package=smalltalk.send((smalltalk.Package || Package), "_named_", [self['@selectedPackage']]);smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_ajax_options_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(package, "_commitPathJs", []), "__comma", [unescape("/")]), "__comma", [self['@selectedPackage']]), "__comma", [".js"]), smalltalk.Dictionary._fromPairs_([smalltalk.send("type", "__minus_gt", ["PUT"]),smalltalk.send("data", "__minus_gt", [smalltalk.send(smalltalk.send((smalltalk.Exporter || Exporter), "_new", []), "_exportPackage_", [self['@selectedPackage']])]),smalltalk.send("error", "__minus_gt", [(function(){return smalltalk.send((typeof window == 'undefined' ? nil : window), "_alert_", [unescape("Commit%20failed%21")]);})])])]);smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_ajax_options_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(package, "_commitPathJs", []), "__comma", [unescape("/")]), "__comma", [self['@selectedPackage']]), "__comma", [".deploy.js"]), smalltalk.Dictionary._fromPairs_([smalltalk.send("type", "__minus_gt", ["PUT"]),smalltalk.send("data", "__minus_gt", [smalltalk.send(smalltalk.send((smalltalk.StrippedExporter || StrippedExporter), "_new", []), "_exportPackage_", [self['@selectedPackage']])]),smalltalk.send("error", "__minus_gt", [(function(){return smalltalk.send((typeof window == 'undefined' ? nil : window), "_alert_", [unescape("Commit%20failed%21")]);})])])]);return smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_ajax_options_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(package, "_commitPathSt", []), "__comma", [unescape("/")]), "__comma", [self['@selectedPackage']]), "__comma", [".st"]), smalltalk.Dictionary._fromPairs_([smalltalk.send("type", "__minus_gt", ["PUT"]),smalltalk.send("data", "__minus_gt", [smalltalk.send(smalltalk.send((smalltalk.ChunkExporter || ChunkExporter), "_new", []), "_exportPackage_", [self['@selectedPackage']])]),smalltalk.send("error", "__minus_gt", [(function(){return smalltalk.send((typeof window == 'undefined' ? nil : window), "_alert_", [unescape("Commit%20failed%21")]);})])])]);})() : nil;
return self;},
args: [],
source: unescape('commitPackage%0A%09selectedPackage%20ifNotNil%3A%20%5B%20%7Cpackage%7C%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20package%20%3A%3D%20Package%20named%3A%20selectedPackage.%0A%09%09jQuery%20%0A%09%09%09ajax%3A%20package%20commitPathJs%2C%20%27/%27%2C%20selectedPackage%2C%20%27.js%27%0A%09%09%09options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27PUT%27.%0A%09%09%09%09%27data%27%20-%3E%20%28Exporter%20new%20exportPackage%3A%20selectedPackage%29.%0A%09%09%09%09%27error%27%20-%3E%20%5Bwindow%20alert%3A%20%27Commit%20failed%21%27%5D%0A%09%09%09%7D.%0A%09%09jQuery%20%0A%09%09%09ajax%3A%20package%20commitPathJs%2C%20%27/%27%2C%20selectedPackage%2C%20%27.deploy.js%27%0A%09%09%09options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27PUT%27.%0A%09%09%09%09%27data%27%20-%3E%20%28StrippedExporter%20new%20exportPackage%3A%20selectedPackage%29.%0A%09%09%09%09%27error%27%20-%3E%20%5Bwindow%20alert%3A%20%27Commit%20failed%21%27%5D%0A%09%09%09%7D.%0A%09%09jQuery%20%0A%09%09%09ajax%3A%20package%20commitPathSt%2C%20%27/%27%2C%20selectedPackage%2C%20%27.st%27%0A%09%09%09options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27PUT%27.%0A%09%09%09%09%27data%27%20-%3E%20%28ChunkExporter%20new%20exportPackage%3A%20selectedPackage%29.%0A%09%09%09%09%27error%27%20-%3E%20%5Bwindow%20alert%3A%20%27Commit%20failed%21%27%5D%0A%09%09%09%7D%5D'),
messageSends: ["ifNotNil:", "named:", "ajax:options:", unescape("%2C"), "commitPathJs", unescape("-%3E"), "exportPackage:", "new", "alert:", "commitPathSt"],
referencedClasses: [smalltalk.Package,smalltalk.Exporter,smalltalk.StrippedExporter,smalltalk.ChunkExporter]
}),
smalltalk.Browser);
