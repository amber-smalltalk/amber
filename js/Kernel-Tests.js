...
;
smalltalk.send(self,"_assert_equals_",["",smalltalk.send(smalltalk.send(document,"_location",[]),"_hash",[])]);
smalltalk.send(smalltalk.send(document,"_location",[]),"_hash_",["test"]);
smalltalk.send(self,"_assert_equals_",["#test",smalltalk.send(smalltalk.send(document,"_location",[]),"_hash",[])]);
return self},
args: [],
