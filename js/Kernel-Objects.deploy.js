...
return smalltalk.send(variables,"_at_put_",[each,smalltalk.send(smalltalk.send(self,"_instVarAt_",[each]),"_asJSON",[])]);
})]);
return variables;
}
}),
...
var self=this;
var result;
smalltalk.send(console,"_log_",[smalltalk.send(smalltalk.send(aString,"__comma",[" time: "]),"__comma",[smalltalk.send(smalltalk.send((smalltalk.Date || Date),"_millisecondsToRun_",[(function(){
result=smalltalk.send(aBlock,"_value",[]);
return result;
})]),"_printString",[])])]);
return result;
}
...
var self=this;
var $1;
$1=smalltalk.send((smalltalk.String || String),"_streamContents_",[(function(s){
return smalltalk.send(self,"_storeOn_",[s]);
})]);
return $1;
}
}),
...
$1=smalltalk.send($2,"_ifTrue_ifFalse_",[aBlock,(function(){
return false;
})]);
return $1;
}
...
var self=this;
var $1;
$1=smalltalk.send(self,"_ifTrue_ifFalse_",[(function(){
}),aBlock]);
return $1;
}
}),
...
var self=this;
var $1;
$1=smalltalk.send(smalltalk.send(smalltalk.send((smalltalk.Smalltalk || Smalltalk),"_current",[]),"_classes",[]),"_select_",[(function(c){
return smalltalk.send(smalltalk.send(c,"_package",[]),"__eq_eq",[self]);
})]);
return $1;
}
}),
...
var self=this;
var $1;
$1=smalltalk.send(self,"_propertyAt_ifAbsent_",["dependencies",(function(){
return [];
})]);
return $1;
}
...
object = {};;
;
smalltalk.send(aDict,"_keysAndValuesDo_",[(function(key,value){
...
var self=this;
smalltalk.send(jQuery,"_getScript_onSuccess_",[smalltalk.send(smalltalk.send(aPrefix,"__comma",[aPackageName]),"__comma",[".js"]),(function(){
return smalltalk.send((smalltalk.Package || Package),"_init_",[aPackageName]);
})]);
return self}
}),
smalltalk.Package.klass);
...
var self=this;
var $1,$2;
$1=smalltalk.send(smalltalk.send(smalltalk,"_classes",[]),"_select_",[(function(each){
return each.pkg.pkgName == aPackageName;
;
})]);
smalltalk.send($1,"_do_",[(function(each){
return smalltalk.init(each);
;
})]);
$2=smalltalk.send($1,"_do_",[(function(each){
...
nodes=smalltalk.send(children,"_collect_",[(function(each){
return smalltalk.send((smalltalk.ClassSorterNode || ClassSorterNode),"_on_classes_level_",[each,others,(0)]);
})]);
nodes=smalltalk.send(nodes,"_sorted_",[(function(a,b){
...
smalltalk.send(nodes,"_do_",[(function(aNode){
return smalltalk.send(aNode,"_traverseClassesWith_",[expandedClasses]);
})]);
...
var self=this;
var $1;
$1=smalltalk.send(smalltalk.send(smalltalk.send(aPoint,"_class",[]),"__eq",[smalltalk.send(self,"_class",[])]),"_and_",[(function(){
...
smalltalk.send(stream,"_nextPutAll_",[smalltalk.send(smalltalk.send(self["@x"],"_printString",[]),"__comma",["@"])]);
$2=smalltalk.send(smalltalk.send(self["@y"],"_notNil",[]),"_and_",[(function(){
return smalltalk.send(self["@y"],"_negative",[]);
})]);
if(smalltalk.assert($2)){
smalltalk.send(stream,"_space",[]);
};
return smalltalk.send(stream,"_nextPutAll_",[smalltalk.send(self["@y"],"_printString",[])]);
})]);
return $1;
}
}),
...
var self=this;
var $1;
$1=smalltalk.send(smalltalk.send((1),"_to_",[anInteger]),"_collect_",[(function(each){
return smalltalk.send(self,"_next",[]);
})]);
return $1;
}
}),
...
result=smalltalk.send(self,"_basicParse_",[aString]);
return result;
}),(function(ex){
return smalltalk.send(smalltalk.send(self,"_parseError_parsing_",[ex,aString]),"_signal",[]);
})]);
return result;
}
}),
...
code=smalltalk.send((smalltalk.String || String),"_streamContents_",[(function(s){
return smalltalk.send(lines,"_withIndexDo_",[(function(l,i){
return smalltalk.send(s,"_nextPutAll_",[smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(i,"_asString",[]),"__comma",[": "]),"__comma",[l]),"__comma",[smalltalk.send((smalltalk.String || String),"_lf",[])])]);
})]);
})]);
...
var self=this;
var pkg;
pkg=smalltalk.send(self,"_packageAt_ifAbsent_",[packageName,(function(){
return smalltalk.send(self,"_error_",[smalltalk.send("Missing package: ","__comma",[packageName])]);
})]);
smalltalk.send(smalltalk.send(pkg,"_classes",[]),"_do_",[(function(each){
return smalltalk.send(self,"_removeClass_",[each]);
})]);
