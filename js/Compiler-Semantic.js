...
$4=lookup;
return $4;
}, function($ctx1) {$ctx1.fill(self,"lookupVariable:", [aNode], smalltalk.LexicalScope)})},
args: ["aNode"],
...
return self}, function($ctx1) {$ctx1.fill(self,"errorUnknownVariable:", [aNode], smalltalk.SemanticAnalyzer)})},
args: ["aNode"],
