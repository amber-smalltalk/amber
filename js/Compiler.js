...
fn: function (aNode){
var self=this;
(($receiver = smalltalk.send(smalltalk.send(smalltalk.send((typeof self == 'undefined' ? nil : self), "_currentClass", []), "_allInstanceVariableNames", []), "_includes_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])])).klass === smalltalk.Boolean) ? ($receiver ? (function(){return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send(smalltalk.send(unescape("self%5B%27@"), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%27%5D")])]);})() : (function(){return (($receiver = smalltalk.send(smalltalk.send((typeof self == 'undefined' ? nil : self), "_knownVariables", []), "_includes_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])])).klass === smalltalk.Boolean) ? (! $receiver ? (function(){smalltalk.send(self['@unknownVariables'], "_add_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(unescape("%28typeof%20"), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%20%3D%3D%20%27undefined%27%20%3F%20nil%20%3A%20")]), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%29")])]);})() : (function(){return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);})()) : smalltalk.send($receiver, "_ifFalse_ifTrue_", [(function(){smalltalk.send(self['@unknownVariables'], "_add_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(unescape("%28typeof%20"), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%20%3D%3D%20%27undefined%27%20%3F%20nil%20%3A%20")]), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%29")])]);}), (function(){return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);})]);})()) : smalltalk.send($receiver, "_ifTrue_ifFalse_", [(function(){return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send(smalltalk.send(unescape("self%5B%27@"), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%27%5D")])]);}), (function(){return (($receiver = smalltalk.send(smalltalk.send((typeof self == 'undefined' ? nil : self), "_knownVariables", []), "_includes_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])])).klass === smalltalk.Boolean) ? (! $receiver ? (function(){smalltalk.send(self['@unknownVariables'], "_add_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(unescape("%28typeof%20"), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%20%3D%3D%20%27undefined%27%20%3F%20nil%20%3A%20")]), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%29")])]);})() : (function(){return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);})()) : smalltalk.send($receiver, "_ifFalse_ifTrue_", [(function(){smalltalk.send(self['@unknownVariables'], "_add_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(unescape("%28typeof%20"), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%20%3D%3D%20%27undefined%27%20%3F%20nil%20%3A%20")]), "__comma", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]), "__comma", [unescape("%29")])]);}), (function(){return smalltalk.send(self['@stream'], "_nextPutAll_", [smalltalk.send((typeof aNode == 'undefined' ? nil : aNode), "_value", [])]);})]);})]);
return self;},
source: unescape('visitVariableNode%3A%20aNode%0A%09%28self%20currentClass%20allInstanceVariableNames%20includes%3A%20aNode%20value%29%20%0A%09%09ifTrue%3A%20%5Bstream%20nextPutAll%3A%20%27self%5B%27%27@%27%2C%20aNode%20value%2C%20%27%27%27%5D%27%5D%0A%09%09ifFalse%3A%20%5B%0A%09%09%09%28self%20knownVariables%20includes%3A%20aNode%20value%29%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09ifFalse%3A%20%5B%0A%09%09%09%09%09unknownVariables%20add%3A%20aNode%20value.%0A%09%09%09%09%09stream%20nextPutAll%3A%20%27%28typeof%20%27%2C%20aNode%20value%2C%20%27%20%3D%3D%20%27%27undefined%27%27%20%3F%20nil%20%3A%20%27%2C%20aNode%20value%2C%20%27%29%27%5D%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09%09ifTrue%3A%20%5B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%09stream%20nextPutAll%3A%20aNode%20value%5D%5D'),
messageSends: ["ifTrue:ifFalse:", "includes:", "allInstanceVariableNames", "currentClass", "value", "nextPutAll:", unescape("%2C"), "ifFalse:ifTrue:", "knownVariables", "add:"],
referencedClasses: []
}),
smalltalk.Compiler);
...
(($receiver = (($receiver = aSelector).klass === smalltalk.Number) ? $receiver =unescape("%3D") : smalltalk.send($receiver, "__eq", [unescape("%3D")])).klass === smalltalk.Boolean) ? ($receiver ? (function(){smalltalk.send(self, "_checkClass_for_", ["Number", receiver]);smalltalk.send(self['@stream'], "_nextPutAll_", [unescape("%24receiver%20%3D%3D")]);smalltalk.send(self, "_visit_", [smalltalk.send(aCollection, "_first", [])]);return inlined=true;})() : nil) : smalltalk.send($receiver, "_ifTrue_", [(function(){smalltalk.send(self, "_checkClass_for_", ["Number", receiver]);smalltalk.send(self['@stream'], "_nextPutAll_", [unescape("%24receiver%20%3D%3D")]);smalltalk.send(self, "_visit_", [smalltalk.send(aCollection, "_first", [])]);return inlined=true;})]);
...
fn: function (){
var self=this;
return smalltalk.send((function(){return smalltalk.send(smalltalk.send((smalltalk.Compiler || Compiler), "_new", []), "_recompile_", [(smalltalk.Browser || Browser)]);}), "_value", []);
return self;},
source: unescape('doIt%20%5E%5BCompiler%20new%20recompile%3A%20Browser%5D%20value'),
messageSends: ["value", "recompile:", "new"],
referencedClasses: [smalltalk.Compiler,smalltalk.Browser]
}),
smalltalk.DoIt);
