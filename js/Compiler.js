...
fn: function (aNode) {
    ...
    aNode._arguments()._do_separatedBy_(function (each) {self['@tempVariables']._add_(each);return self['@stream']._nextPutAll_(each);}, function () {return self['@stream']._nextPutAll_(unescape("%2C%20"));});
...
fn: function (aNode) {
    ...
    aNode._parameters()._do_separatedBy_(function (each) {self['@tempVariables']._add_(each);return self['@stream']._nextPutAll_(each);}, function () {return self['@stream']._nextPutAll_(unescape("%2C%20"));});
...
fn: function (aNode) {
    var self = this;
    aNode._temps()._do_(function (each) {self['@tempVariables']._add_(each);self['@stream']._nextPutAll_("var ".__comma(each).__comma(unescape("%3Dnil%3B")));return self['@stream']._nextPutAll_(smalltalk.String._cr());});
...
fn: function (aNode) {
    ...
    var index = nil;
    index = 0;
    self['@tempVariables']._includes_("$rec")._ifFalse_(function () {return self['@tempVariables']._add_("$rec");});
...
fn: function () {
    var self = this;
    return self['@unknownVariables']._copy();
    return self;
},
...
fn: function () {
    var self = this;
    return self['@tempVariables']._copy();
    return self;
},
...
fn: function () {
    var self = this;
    return function ($rec) {$rec._addAll_(self._tempVariables());return $rec._yourself();}(self._pseudoVariables());
    return self;
},
