...
var self=this;
var $1;
$1=smalltalk.send(smalltalk.send(self,"_pseudoVars",[]),"_at_ifAbsent_",[smalltalk.send(aStringOrNode,"_value",[]),(function(){
return smalltalk.send(smalltalk.send(self,"_args",[]),"_at_ifAbsent_",[smalltalk.send(aStringOrNode,"_value",[]),(function(){
return smalltalk.send(smalltalk.send(self,"_temps",[]),"_at_ifAbsent_",[smalltalk.send(aStringOrNode,"_value",[]),(function(){
return nil;
})]);
})]);
})]);
...
var self=this;
var $1;
$1=smalltalk.send(smalltalk.send(self,"_isInlined",[]),"_and_",[(function(){
return smalltalk.send(smalltalk.send(self,"_outerScope",[]),"_canInlineNonLocalReturns",[]);
})]);
return $1;
}
}),
...
if(($receiver = $2) == nil || $receiver == undefined){
$1=smalltalk.send(smalltalk.send(self,"_iVars",[]),"_at_ifAbsent_",[smalltalk.send(aNode,"_value",[]),(function(){
return nil;
})]);
} else {
$1=$2;
...
self["@pseudoVars"];
smalltalk.send(smalltalk.send(smalltalk.send((smalltalk.Smalltalk || Smalltalk),"_current",[]),"_pseudoVariableNames",[]),"_do_",[(function(each){
$1=smalltalk.send((smalltalk.PseudoVar || PseudoVar),"_on_",[each]);
smalltalk.send($1,"_scope_",[smalltalk.send(self,"_methodScope",[])]);
...
var self=this;
var $1,$2,$3;
$1=smalltalk.send(smalltalk.send(self,"_isArgVar",[]),"_or_",[(function(){
return smalltalk.send(self,"_isPseudoVar",[]);
})]);
...
var self=this;
var $1;
$1=smalltalk.send(smalltalk.send("self[\x22@","__comma",[smalltalk.send(self,"_name",[])]),"__comma",["\x22]"]);
return $1;
}
}),
...
smalltalk.send(smalltalk.send(aNode,"_parameters",[]),"_do_",[(function(each){
...
return smalltalk.send(each,"_receiver_",[smalltalk.send(aNode,"_receiver",[])]);
})]);
...
smalltalk.send(self,"_validateVariableScope_",[each]);
return smalltalk.send(self["@currentScope"],"_addTemp_",[each]);
})]);
